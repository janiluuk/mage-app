...
<template>
    <div class="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
        <div class="flex flex-column align-items-center justify-content-center">
            <img src="/demo/images/notfound/logo-blue.svg" alt="Vimage logo" class="mb-5 w-6rem flex-shrink-0" />
            <div
                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center"
                    ...
                    <h1 class="text-900 font-bold text-3xl lg:text-5xl mb-2">Not found, sorry mate! </h1>
                    <h4 class="text-white">Try <a href="/">main page</a>?</h4>
                        <router-link to="/" class="w-full flex align-items-center py-5 border-300 border-bottom-1">
                            ...
                            <span class="ml-4 flex flex-column">
                                ...
                                <span class="text-600 lg:text-xl"></span> </span>
                        </router-link>
                        <router-link to="/" class="w-full flex align-items-center py-5 border-300 border-bottom-1">
                        ...
                        <router-link to="/" class="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
                            ...
                            <span class="ml-4 flex flex-column">
                                <span class="text-900 lg:text-xl font-medium mb-0">And hey!</span>
                                <span class="text-600 lg:text-xl">Check out other AI stuff: <a href="https://tinybots.net/artbot">Artbot</a></span>
                            </span>
                        </router-link>
                </div>
            </div>
